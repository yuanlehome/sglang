...
class DeepSeekV4IndexerPool(KVCache):
    ...
    def _create_buffer(self):
        # Indexer always uses FP8 format (to leverage deep_gemm.fp8_paged_mqa_logits),
        # regardless of the main model's kv_cache_dtype setting.
        # FP8 mode: 128 fp8 bytes + 1 fp32 scale = 132 bytes/token
